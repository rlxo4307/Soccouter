...
public class dtoPlayerRank_Shots_On_Target {
	...
	public dtoPlayerRank_Shots_On_Target() { }
	
	public dtoPlayerRank_Shots_On_Target (int rank, int tid_sofa, int pid_sofa, String pko, String pimg, String tko, String timg, int appearances, int goals, int assists, int attack_points,
