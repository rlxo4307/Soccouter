...
public class dtoPlayerRank_Penalties_Taken {
	...
	public dtoPlayerRank_Penalties_Taken() { }
	
	public dtoPlayerRank_Penalties_Taken (int rank, int tid_sofa, int pid_sofa, String pko, String pimg, String tko, String timg, int appearances, int goals, int assists, int attack_points,
