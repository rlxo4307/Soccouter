...
public class dtoPlayerRank_Fouls {
	...
	public dtoPlayerRank_Fouls() { }
	
	public dtoPlayerRank_Fouls (int rank, int tid_sofa, int pid_sofa, String pko, String pimg, String tko, String timg, int appearances, int goals, int assists, int attack_points,
