...
public class dtoPlayerRank_Total_Shots {
	...
	public dtoPlayerRank_Total_Shots() { }
	
	public dtoPlayerRank_Total_Shots (int rank, int tid_sofa, int pid_sofa, String pko, String pimg, String tko, String timg, int appearances, int goals, int assists, int attack_points,
