...
public class dtoPlayerRank_Attack_Points {
	...
	public dtoPlayerRank_Attack_Points() { }
	
	public dtoPlayerRank_Attack_Points (int rank, int tid_sofa, int pid_sofa, String pko, String pimg, String tko, String timg, int appearances, int goals, int assists, int attack_points,
