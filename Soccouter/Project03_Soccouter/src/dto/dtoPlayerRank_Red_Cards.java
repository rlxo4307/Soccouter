...
public class dtoPlayerRank_Red_Cards {
	...
	public dtoPlayerRank_Red_Cards() { }
	
	public dtoPlayerRank_Red_Cards (int rank, int tid_sofa, int pid_sofa, String pko, String pimg, String tko, String timg, int appearances, int goals, int assists, int attack_points,
