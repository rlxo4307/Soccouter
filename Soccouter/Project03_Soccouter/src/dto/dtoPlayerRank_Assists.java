...
public class dtoPlayerRank_Assists {
	...
	public dtoPlayerRank_Assists() { }
	
	public dtoPlayerRank_Assists (int rank, int tid_sofa, int pid_sofa, String pko, String pimg, String tko, String timg, int appearances, int goals, int assists, int attack_points,
