...
public class InfoLeagueStat {

	public static ArrayList<dtoLeagueStat> InfoLeagueStat(String league) {
		String year = "2021";
		Connection.Response response;
		Document document = null;
		try {
			response = Jsoup.connect("https://sports.news.naver.com/wfootball/record/index?category="+league)
		...
		for (int i = 0; i < rankLine.length; i++) {
			...
			int idxGoalGap_b = goalGap[i].indexOf("teamRankingGroup");
			int dtoGoalGap = Integer.parseInt(goalGap[i].substring(idxGoalGap_a+9, idxGoalGap_b-2 ));
