...
<head>
	...
	<script type="text/javascript">
		...
		function searchFunction() {
			searchRequest.open("Post", "./UserSearchServlet?userName=" + encodeURIComponent(document.getElementById("userName").value), true); // js에서 ajax 통신시 URI(o), URL(x)
		...
		<table class="table" style="text-align: center; border: 1px solid #dddddd">
			...
			<tbody>
				...
				<tr>
					...
					<td><input class="form-control" type="text" id="registerTeamName" size="20"></td>
				</tr>
				<tr>
